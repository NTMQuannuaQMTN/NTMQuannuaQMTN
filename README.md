...
- Grade 9: Class portfolio (Repo name: [8A13-MV-Class](https://github.com/NTMQuannuaQMTN/8A13-MV-Class/)).
...
- Grade 12: Developing a photo-sharing social media app named Homee, getting 200+ users.
- Grade 12: Founding the school's tech club, dev club, and AI club named The Noders.
- Grade 12: Founding Doorians Lab (Link: [https://doorians.com/](https://www.doorians.com/)), an agency with a mission to build tech products for startups, getting 5 clients from Vietnam and the USA.
